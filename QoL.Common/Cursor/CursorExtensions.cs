...
namespace QoL.Common.Cursor
{
    public static class CursorExtensions
    {
        ...
        public static void SetCursorStyle(this CM_PageBase page, CursorStyle style)
        {
            ...
            switch (style)
            {
                case CursorStyle.Hand:
                    state.Cursor!.m_cursorSprite.enabled = false;
                    state.Cursor!.m_cursorSpriteDrag.enabled = false;
                    state.HandSprite!.gameObject.SetActive(true);
                    break;
                default:
                    state.Cursor!.m_cursorSprite.enabled = true;
                    state.Cursor!.m_cursorSpriteDrag.enabled = true;
        ...
        {
            Plugin.LogDebug("UpdateCursorRef");
