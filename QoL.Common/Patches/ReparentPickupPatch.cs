...
namespace QoL.Common.Patches
{
    ...
    /// were swapped.
    /// </summary>
    public class ReparentPickupPatch : MTFOPatch
    {
        public static ReparentPickupPatch? Instance { get; private set; }
        ...
        protected override void Apply()
        {
            ...
            this.PatchMethod<ConsumablePickup_Core>(
                ...
                parameters: new[] { typeof(ItemDataBlock), },
            ...
            this.PatchMethod<ResourcePackPickup>(
                ...
                patchType: PatchType.Postfix,
                postfixMethodName: nameof(ItemInLevel__Setup__Postfix));
            this.PatchMethod<ArtifactPickup_Core>(
                methodName: nameof(ArtifactPickup_Core.Setup),
                parameters: new[] { typeof(ItemDataBlock), },
                patchType: PatchType.Postfix,
                postfixMethodName: nameof(ItemInLevel__Setup__Postfix));
            this.PatchMethod<ArtifactPickup_Core>(
